        ...
        <div className="flex justify-between ">
            <div className="min-w-72 border-t hidden xl:flex flex-col p-6 gap-6">
                ...
                <div className="flex gap-2 items-center bg-blue-600 text-white px-2 py-3 rounded-lg">
                    <Image className="size-6" src='/Nav Bar.png' alt="home-icon" width={100} height={100} />
                    Dashboard
                </div>
                ...
                <div className="flex items-start gap-6 flex-col lg:flex-row">
                    <div className="bg-white p-6 rounded-xl h-fit flex flex-col gap-6 w-full lg:w-1/2 lg:min-w-[24rem]">
                        <div className="flex gap-6 flex-col">
                            <div className="flex flex-col gap-2 w-full">
                                <div className="font-bold">Rental Details</div>
                            </div>
                    ...
                    <div className="rounded-xl size-full flex flex-col gap-6 lg:w-1/2 lg:min-w-[24rem]">
                        ...
                        <div className="flex gap-6 flex-col bg-white p-7 rounded-lg">
                                ...
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        ...
                                        <div>
                                            ...
                                            <div className="font-bold text-sm">$110.00</div>
                                        </div>
                                    </div>
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/images/SUV.png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>BMW i8</div>
                                        <div>
                                            <div className="font-thin text-xs opacity-50">20 Nov</div>
                                            <div className="font-bold text-sm">$90.00</div>
                                        </div>
                                    </div>
                                    <div className='text-xs opacity-50 flex'>
                                        SUV
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>RollsRoyse Phantom</div>
                                        <div>
                                            <div className="font-thin text-xs opacity-50">19 0ct</div>
                                            <div className="font-bold text-sm">$120.00</div>
                                        </div>
                                    </div>
                                    <div className='text-xs opacity-50 flex'>
                                        Luxury
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>Toyota Land Cruiser</div>
                                        <div>
                                            <div className="font-thin text-xs opacity-50">29 May</div>
